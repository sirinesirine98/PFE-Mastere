...
class CreateDemandeurRdvTable extends Migration
{
    ...
    Schema::create('demandeur_rdv', function (Blueprint $table) {
            ...
            $table->string('nom_medecin')->nullable();//to add relationship
            $table->date('date_rdv')->nullable();//to add relationship
            $table->time('heure_rdv')->nullable();//to add relationship
